...
public class ShipmentOrder
{
  ...
  public boolean assignShipmentOrder(WarehouseStaff staff,TimeEstimate timeToComplete,PriorityLevel priority,boolean toBeApproved)
  {
  ...
  public boolean startShipmentOrder()
  {
    boolean wasEventProcessed = false;
  ...
  public boolean completeShipmentOrder()
  {
    boolean wasEventProcessed = false;
  ...
  public boolean disapproveShipmentOrder(Date date,String reason)
  {
    boolean wasEventProcessed = false;
    ...
    {
      case Completed:
        // line 22 "WareFlowStates.ump"
        doDisapproveShipmentOrder(date,reason);
        setStatus(Status.InProgress);
        wasEventProcessed = true;
        break;
      default:
  ...
  public boolean approveShipmentOrder()
  {
    boolean wasEventProcessed = false;
